...
& =e^{k-1} \cdot {\color{darkseagreen}e}\\
& =e^k
\end{aligned}

The useful way to _recall_ what the Chernoff bound tells us is the following: for *independent* 0/1 random variables, the probability that $X$ deviates from it sexpectatio by a large amount is *extremely* small.
