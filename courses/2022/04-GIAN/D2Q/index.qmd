...
6. Generalize the color coding approach for Longest Path to: (a) $k$-Cycle where $H$ is a cycle on $k$ vertices, (b) Tree Subgraph Isomorphism, where $H$ is restricted to being a tree.
