...
1. Come up with an example where the majority rounding idea for the Closest String LP does _not_ work.
...
5. Design a PTAS for Max Bisection on graphs of minimum degree $d$.

6. Prove that selecting coordinates according to the normal distribution gives unifom distribution on unit sphere.

7. Prove that for every half plane, the projection of a random unit vector on the half plane has a "u.a.r direction".
