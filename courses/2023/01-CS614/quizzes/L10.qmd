...
We argued in class that the greedy approach to solving the unweighted Set Cover problem achieves an approximation ration of $O(\lg m)$. Argue that this bound is tight, i.e, come up with examples where the algorithm picks sets in a manner that 
