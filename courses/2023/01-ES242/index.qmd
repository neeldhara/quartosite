...
- Each lab will have a task worth 2 points. The total number of points you can earn through labs is capped at 20, and accounts for 20% of the grade.

- Most classes will start with a short objective-type quiz based on the material from the previous class, worth 2 points. The total number of points you can earn through quizzes is capped at 20, and accounts for 20% of the grade.
