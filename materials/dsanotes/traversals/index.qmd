...
![Bread-first search, courtsey XKCD](../figures/ch6-breadfirst.png){width=500px}
...
![The problem with Wikipedia, as observed by XKCD](../figures/ch6-xkcd-wikipedia.png){width=500px}
...
![Careful what you wish for with DFS (thanks again, XKCD)...](../figures/ch6-xkcd-dfs.png){width=500px}
