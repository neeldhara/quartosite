...
### *An elevator^[for a suitably long elevator ride --- assume skyscraper.] pitch for my research interests*
...
For a delightful history of the field, I recommend [@revolution], while [@CyganFKLMPPS15] is a very accessible introduction the field, only assuming a background in undergraduate algorithms. This framework has been my default way of thinking about algorithms for a while now. In the following, I delve a little further into the specifics of the kinds of problems I have been working on.
